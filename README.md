...
RESPOSTA
  ...
  > val counts = textFile.flatMap(line => line.split(" ")).map(word => (word, 1)).reduceByKey(_ + _)
    Seta objeto "counts", que esta fazendo map reduce, para obter a contagem de cada string separada por " " (espaço) no arquivo (ou seja, a contagem das palavras contidas no arquivo)
